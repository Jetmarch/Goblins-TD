...
{
    public sealed class GameplayProrotypeSceneInstaller_v2 : LifetimeScope
    {
        [Header("Game Loop")] 
        ...
        private void ConfigureControllers(IContainerBuilder builder)
        {
            ...
            builder.Register<GameLoopStartController>(Lifetime.Singleton).AsImplementedInterfaces();
        }
